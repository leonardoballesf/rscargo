                            ...
                            <div class="panel panel-danger mbn5">
                              ...
                              <div class="panel-body bg-light dark">
                                ...
                                print($this->html->form(array(
                                            "method" => "POST",
                                            "action" => '',
                                            "id" => 'form_suppliers_edit',
                                            "name" => 'form_suppliers_edit',
                                ...
                                <div class="section row">
                                    ...
                                    <div class="section mb5">
                                        <label for="suppliers_is_active" class="field prepend-icon">
                                            <?php  
                                            print($this->html->input('suppliers_is_active','select',$this->statusType['select'],
                                                    array(
                                                        "id"=>'suppliers_is_active',
                                                        "class"=>"select2-single form-control",
                                                        "default"=>array("value"=>$value['suppliers_is_active'],"option"=>$this->statusType['type'][$value['suppliers_is_active']]),
                                                    ),
                                                  false)
                                            );
                                            ?> 
