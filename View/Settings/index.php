            ...
            <div class="panel panel-danger panel-border top mb15">
              ...
              <div class="panel-heading">
                ...
                <span class="panel-title text-uppercase text-center">Información de la Sucursal</span>
                    <?php  
                        print($this->html->link("<i class='imoon imoon-pencil fs18'></i>",
                                array(
                                    'controller' => 'Settings',
                                    'action' => 'edit',
                                    'params' => array(
              ...
              <div class="panel-body bg-light dark">
                ...
                <div class="admin-form">
                    ...
                    <div class="section mb15">
                        <label class="field prepend-icon">
                            <?php  
                            print($this->html->input('bookshop_location_address','textarea', trim($value['bookshop_location_address']),
                                    array(
                                        "id"=>'bookshop_location_address',
                            ...
                            ?> 
                            <label for="bookshop_location_address" class="field-icon">
                    ...
                    <div class="section mb15">
                        <label class="field form-group">
                            <?php  
                            print($this->html->input('business_bookshop','select',$this->bookshopLocationList,
                                    array(
                                        "id"=>'business_bookshop',
                    ...
                    <div class="section mb15">
                        <label class="field prepend-icon form-group">
                            <?php  
                            print($this->html->input('business_bookshop','select',$this->bookshopRegionsList,
                                    array(
                                        "id"=>'business_bookshop',
                                        "class"=>"select2-single form-control",
                                        "readonly"=>"true",
