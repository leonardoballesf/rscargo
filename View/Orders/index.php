...
<section id="content" class="table-layout animated fadeIn">
        ...
        <!-- recent activity table -->
          <div class="panel">
            <div class="panel-heading">
              <span class="panel-title hidden-xs">LISTADO DE PROVEEDORES</span>
            </div>
             
            <div class="panel-body pn ">
              <div class="table-responsive ">
                  <table id="orderstable" class="table table-striped table-hover dataTable no-footer fs12">
                  <thead>
                    <tr class="bg-light">
                      ...
                      <th class="text-center bg-danger">HORA</th>
        ...
        <aside class="tray tray-right tray300">
          ...
          <div class="admin-form">
            ...
            <h4> FILTRAR ÁRTICULOS</h4>

            <hr class="short">

            <form name="catalog_filters" id="users_filters" >
            ...
            <h5><small>PROVEEDOR</small></h5>
            <div class="section mb15 ">
              <label class="field form-group">
                <?php  
                print($this->html->input('orders_suppliers','select',$this->ordersSuppliers,
                        array(
                            "id"=>'orders_suppliers',
            ...
            <div class="section">
                <button class="btn btn-default btn-sm ph25" id="search" type="button">Aplicar Filtro</button>
            </div>
            </form>
          </div>
