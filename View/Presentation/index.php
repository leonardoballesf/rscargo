    ...
    <section id="content" class="table-layout animated">
        ...
        <?php //print('<pre>');print_r($this->List);print('</pre>');?>
        ...
        <div class="panel">
          ...
          <div class="panel-body pn ">
            <div class="table-responsive ">
                <table id="presentationtable" class="table table-striped table-hover dataTable no-footer fs12">
                <thead>
                  <tr class="bg-light">
                    <th class="text-center bg-danger">ID</th>
                    <th class="text-center bg-danger">PRESENTACIÓN</th>
                    <th class="text-center bg-danger">ABREVIACIÓN</th>
                    <th class="text-center bg-danger">UNIDADES</th>
