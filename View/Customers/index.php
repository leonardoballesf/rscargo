...
<section id="content" class="table-layout animated fadeIn">
        ...
        <div class="panel">
            ...
            <div class="panel-body pn ">
              <div class="table-responsive ">
                  <table  id="customerstable" class="table table-striped table-hover dataTable no-footer fs12">
                  <thead>
                    <tr class="bg-light">
                      <th class="text-center bg-danger">ID</th>
                      <th class="text-center bg-danger">CLIENTE</th>
                      <th class="text-center bg-danger">CODIGO</th>
        ...
        <div class="panel panel-danger panel-border top mb15">
          ...
          <div class="admin-form">
            ...
            <!-- section -->
            <h5><small class="text-left text-uppercase">Código del Cliente:</small></h5>
            <div class="section mb10">
                <label for="customers_code" class="field prepend-icon">
                    <?php  
                    print($this->html->input('customers_code','text','',
                            array(
                                "id"=>'customers_code',
                                "class"=>"gui-input",
                                "placeholder"=>'Código'
                    ...
                    ?>
                    <label for="customers_code" class="field-icon">
            ...
            <div class="section mb10">
                <label for="customers_name" class="field prepend-icon">
                    <?php  
                    print($this->html->input('customers_name','text','',
                            array(
                                "id"=>'customers_name',
                                "class"=>"gui-input",
            ...
            <div class="section mb15">
                <label for="customers_created" class="field prepend-icon form-group">
                    <?php  
                    print($this->html->input('customers_created','text','',
                            array(
                    ...
                    ?>
                    <label for="customers_created" class="field-icon">
            ...
            <div class="section mb15">
                <label for="customers_is_active" class="field form-group">
                    <?php  
