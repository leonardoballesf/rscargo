        ...
        <div class="panel">
          ...
          <div class="panel-body pn ">
            <div class="table-responsive ">
                <table id="tariffstable" class="table table-striped table-hover dataTable no-footer fs12">
                <thead>
                  <tr class="bg-light">
                    <th class="text-center bg-danger">ID</th>
                    <th class="text-center bg-danger">NOMBRE</th>
                    <th class="text-center bg-danger">VALOR</th>
