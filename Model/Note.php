...
class NoteModel extends Model
{
    ...
    public function editSave($data)
    {
        ...
        $response = $this->db->update('note', $postData,"`noteid` = '{$data['noteid']}' AND userid = '{$_SESSION['userid']}'");
    ...
    {
        $response = $this->db->delete('note', "`noteid` = {$data['noteid']} AND userid = '{$_SESSION['userid']}'");
