...
var Core = function(options) {
   ...
   var runFooter = function() {
    ...
    var runMenuHeader = function() {
    
    
    // Searchbar - Mobile modifcations
    var option;
    
      $('#MenuHeader').on('click', 'li', function(e) {
            
          option=$(this);

          localStorage.removeItem('h_menu_active_id');
          localStorage.removeItem('v_menu_active_id');
          localStorage.setItem("h_menu_active_id", option.attr('id'));
          localStorage.setItem("v_menu_active_id", option.attr('id'));
          localStorage.setItem("op_menu-open", option.attr('menu'));

          
      });
      
      $('#MenuLeft').on('click', 'ul > li', function(e) {
      ...
      if (localStorage.getItem("v_menu_active_id") !== null || localStorage.getItem("h_menu_active_id") !== null) {

        $('a.accordion-toggle').removeClass('menu-open');
        $("#"+localStorage.getItem("v_menu_active_id")+"").siblings('li').removeClass('active').end().addClass('active');
        $("#"+localStorage.getItem("h_menu_active_id")+"").siblings('li').removeClass('active').end().addClass('active');

        $("#"+localStorage.getItem("op_menu-open")+"").siblings('a.accordion-toggle').removeClass('menu-open').end().addClass('menu-open');
        $("#"+localStorage.getItem("v_menu_active_id")+"").find('li.a').addClass('active');
   ...
   var runHeader = function() {
      ...
      $('.topbar-menu-toggle').on('click', function() {
        ...
        var $menu = $('#topbar-dropmenu'+'.'+$(this).attr('id'));
      ...
      $('div').on('click', '.metro-modal', function() {
         metroBG.fadeOut('fast');
         setTimeout(function() {
            menu.slideToggle(150).toggleClass('topbar-menu-open');
         }, 250);
