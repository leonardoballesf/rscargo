$(document).ready(function() {
    ...
    $("#btn_edit_acept").on("click", function(event) {
        ...
        return $("#form_packages_edit").submit();
    });

    $("form#form_packages_edit").validate({
        ...
        submitHandler: function(form) {
            var confirm = bootbox.confirm({
                ...
                callback: function(result) {
                    if (result) {
                        var postData = $("form#form_packages_edit").serialize();
        ...
        messages: {
            ...
            packages_bulk: {
                required: 'Ingrese el volumen del paquete'
            },
    ...
    $("input[type='checkbox']").on("click", function() {
        ...
        $.ajax({
            ...
            .done(function(data, textStatus, jqXHR) {
                ...
                if (response.message_type == 1) {} else {}
            })
            .fail(function(jqXHR, textStatus, errorThrown) {
                if (console && console.log) {
                    console.log("La solicitud a fallado: " + textStatus);
