$(document).ready(function() {
    ...
    $('#btn_edit_acept').on('click', function (event) {
        ...
        return $("#form_users_edit").submit();    
    });

    $("form#form_users_edit").validate({
    ...
    var confirm = bootbox.confirm({
        title: "CONFIRMACIÓN",
        message: "Va a enviar una solicitud de modificación de usuario, ¿Está seguro?.",
        buttons: {
            cancel: {
        ...
        if(result){
            ...
            var postData = $("form#form_users_edit").serialize();
