$(document).ready(function () {
  ...
  localStorage.setItem("v_menu_active_id", "v_menu_catalog");
  localStorage.setItem("h_menu_active_id", "h_menu_catalog");
  ...
  var tabla = $("#businesstable").DataTable({
    ...
    processing: true,
    serverSide: true,
    ajaxSource: "Business/businessJson",
    columns: [
    ...
    oLanguage: {
      ...
      sInfo:
        '<span class="text-danger">Cantidad: <strong> _TOTAL_ </strong> Mostrando [_START_ de _END_]</span>',
  ...
  $("#search").on("click", function () {
    ...
    if (input_empty > 0) {
      var dialog = bootbox.dialog({
        ...
        message:
          '<p><i class="fa fa-warning"></i> &nbsp;Debe seleccionar una opcion para aplicar el filtrado</p>',
      });
      ...
      tabla
        .column()
        .columns(0)
        .search("" + $("#catalog_code").val() + "");
      tabla
        .column()
        .columns(1)
        .search("" + $("#catalog_description").val() + "");
