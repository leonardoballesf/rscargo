...
localStorage.setItem("v_menu_active_id", "v_menu_bookshop");
localStorage.setItem("h_menu_active_id", "h_menu_bookshop");
localStorage.setItem("op_menu-open", "op_principal");          

/*INICIALIZACION DE COMPONENTE DATATABLE PARA LA TABLA CATALOG*/    

    var tabla = $('#bookshoptable').DataTable( {
        "iDisplayLength": 5,
        "sDom": 'rtip',
        "filter": true,
        "info": true,
