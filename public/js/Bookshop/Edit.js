$(document).ready(function() {
    ...
    $('#btn_bookshop_edit').on('click', function (event) {
       event.preventDefault();
       return $("#form_bookshop_edit").submit();    
    });
    ...
    $("form#form_bookshop_edit").validate({
    ...
    var confirm = bootbox.confirm({
        ...
        if(result){
            ...
            var postData = $("form#form_bookshop_edit").serialize();
